...
const resolvers = {
  ...
  Mutation: {
    ...
    createDraft: (_parent: any, args: { data: PostCreateInput, authorEmail: string }, context: Context) => {
    ...
    togglePublishPost: async (_parent: any, args: { id: number }, context: Context) => {
      try {
    ...
    incrementPostViewCount: (_parent: any, args: { id: number }, context: Context) => {
      return context.prisma.post.update({
        where: { id: args.id || undefined },
        data: {
          viewCount: {
